...
public class ServerImpl implements Server {
    ...
    final private List<String> characters = List.of("Batman", "Superman");
    final private List<String> questions = List.of("Am i a human?", "Am i a character from a movie?");
    final private List<String> guessess = List.of("Batman", "Superman");
